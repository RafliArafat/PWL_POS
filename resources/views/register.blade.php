...
@section('auth_body')
    <form action="{{route('proses_register')}}" method="POST">
        ...
        <div class="input-group mb-3">
            <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" value="{{old('name')}}" placeholder="{{__('adminlte::adminlte.password')}}" autofocus>
            <div class="input-group-append">
                <div class="input-group-text">
        ...
        <button type="sumbit" class="btn btn-block {{config('adminlte.classes_auth_btn', 'btn-flat btn-primary')}}">
